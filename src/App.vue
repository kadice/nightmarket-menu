...
const categories = reactive([
    {
        name: '炭燒串烤 grill',
        items: [
            { short: '牛串', name: '超多汁牛肉烤串', name2: 'beef', price: 1200, msg: '來自拉札罕放牧區，這隻牛的肌肉比你還緊實，烤了也比你香', count: 0 },
            { short: 'G串', name: 'DoDo鳥腿肉烤串', name2: 'chicken', price: 1000, msg: '渡渡鳥界滿級精選大腿肉，好吃程度不輸你家陸行鳥', count: 0 },
            { short: '魚串', name: '白肉魚', name2: 'fish', price: 1000, msg: '賣魚的說吃這魚可以加直爆，不管你信不信反正我是信了', count: 0 },
            { short: '香腸', name: '烤香腸(附泡菜)', name2: 'sausage', price: 1000, msg: '泡菜是靈魂，香腸只是載具，不接受單點香腸！', count: 0 },
            { short: '青菜', name: '烤時蔬', name2: 'vegetable', price: 1000, msg: '蔬菜的使命就是幫你少一點罪惡感，烤了更像在做健康選擇', count: 0 },
            { short: '烤蝦', name: '焗烤鮮蝦', name2: 'shrimp', price: 1200, msg: '蝦不是重點，起司才是。蝦只是拿來說服自己吃的是海鮮', count: 0 },
            { short: '海螺', name: '烤海螺', name2: 'snail', price: 1500, msg: '老闆為這顆螺跑了四個市場，請尊重牠的旅程', count: 0 },
        ],
    },
    {
        name: '精選炸物 fried',
        items: [
            ...
            { short: '花枝', name: '炸一堆花枝圈', name2: 'squid', price: 1000, msg: '我賣花枝圈的原則就是幹你娘塞爆！', count: 0 },
            { short: '蟹餅', name: '炸蟹肉餅', name2: 'crab cake', price: 1000, msg: '製作過程中沒有真正螃蟹受傷，只有老闆燙傷', count: 0 },
            { short: '炸魚', name: '酥炸魚塊', name2: 'fish', price: 1000, msg: '外表金酥脆，內底超Juicy，呼你呷嘎ㄟ彈舌', count: 0 },
        ],
    },
    {
        name: '飲品 drink',
        items: [
            { short: '紅茶', name: '紅茶', name2: 'black tea', price: 500, msg: '烏爾達哈紅茶，解膩好選擇，解完再多吃兩串', count: 0 },
            { short: '奶茶', name: '奶茶', name2: 'milk tea', price: 700, msg: '早餐店奶茶，沒有賣鮮奶茶，因為老闆喜歡早餐店奶茶', count: 0 },
            { short: '豆漿', name: '豆漿', name2: 'soy milk', price: 700, msg: '要紅茶豆漿，你就各買一杯自己加', count: 0 },
            { short: '麥仔茶', name: '麥仔茶', name2: 'barley tea', price: 500, msg: '愛○味麥仔～茶～(老闆沒接業配，但歡迎洽談)', count: 0 },
